...
class Settings extends MX_Controller {
    ...
    public function update() {
        ...
        if (!empty($email)) {
            ...
            // Validating Bag Price Field           
            $this->form_validation->set_rules('bags', 'Bag Price', 'trim|xss_clean');
             // Validating Pack Price Field           
             $this->form_validation->set_rules('packs', 'Pack Price', 'trim|xss_clean');
              // Validating Jug Price Field           
            $this->form_validation->set_rules('jugs', 'Jug Price', 'trim|xss_clean');
