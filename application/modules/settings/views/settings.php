                ...
                <div class="adv-table editable-table ">
                    <div class="clearfix row">
                        ...
                        <form role="form" action="settings/update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Factory Email</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Bag Price (<?php echo $settings->currency; ?>)</label>
                                <input type="number" min="0" class="form-control" name="bags" id="exampleInputEmail1" value='<?php
                                if (!empty($settings->bags)) {
                                    echo $settings->bags;
                                }
                                ?>' placeholder="Bag Price">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Pack Price (<?php echo $settings->currency; ?>)</label>
                                <input type="number" min="0" class="form-control" name="packs" id="exampleInputEmail1" value='<?php
                                if (!empty($settings->packs)) {
                                    echo $settings->packs;
                                }
                                ?>' placeholder="Pack Price">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Jug Price (<?php echo $settings->currency; ?>)</label>
                                <input type="number" min="0" class="form-control" name="jugs" id="exampleInputEmail1" value='<?php
                                if (!empty($settings->jugs)) {
                                    echo $settings->jugs;
                                }
                                ?>' placeholder="Jug Price">
                            </div>
