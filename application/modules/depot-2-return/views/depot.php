                            ...
                            <tr class="">
                                ...
                                <?php if ($this->ion_auth->in_group(array('admin', 'Depot2'))) { ?>
                                    <td class="no-print">
                                        ...
                                        <a class="btn btn-info btn-xs btn_width delete_button" title="<?php echo lang('delete'); ?>" href="depot-2-return/depot/delete?id=<?php echo $item->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"> </i></a>
                                    </td>
                                <?php } ?>
                            </tr>
                        <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" action="depot-2-return/depot/addItem" class="clearfix" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="editDonorForm" class="clearfix" action="depot-2-return/depot/addItem" method="post" enctype="multipart/form-data">
                <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Bags*</label>
...
<script type="text/javascript">
                                    $(document).ready(function () {
                                        $(".editbutton").click(function (e) {
                                            ...
                                            $('#myModal2').modal('show');
                                            $.ajax({
                                                url: 'depot-2-return/depot/editItemByJason?id=' + iid,
                                                method: 'GET',
                                                data: '',
                                                dataType: 'json',
