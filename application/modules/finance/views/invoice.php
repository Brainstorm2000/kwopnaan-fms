                    ...
                    <div class="row invoice-list">
                        ...
                        <div class="col-md-12 invoice_head clearfix">
                            ...
                            <div class="col-md-6 text-right invoice_head_right">
                                <img alt="" src="<?php echo $this->settings_model->getSettings()->logo; ?>" width="100" height="100">
                            </div>
                        ...
                        <div class="col-md-12">
                            <h4 class="text-center" style="font-weight: bold; margin-top: 20px; text-transform: uppercase;">
                                <?php echo lang('payment') ?> <?php echo ('RECEIPT') ?>
                            </h4>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6 pull-right" style="text-align: left;">
                                ...
                                <div class="col-md-12 row details" style="">
                                    <p>
                                        <label class="control-label"><?php echo ('Receipt'); ?>  </label>
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                            if (!empty($payment->id)) {
                                                echo $payment->id;
            ...
            <div class="col-md-5 no-print" style="margin-top: 20px;">
                ...
                <div class="text-center col-md-12 row">
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                        <a href="finance/editPayment?id=<?php echo $payment->id; ?>" class="btn btn-info btn-sm editbutton pull-left"><i class="fa fa-edit"></i> <?php echo lang('edit'); ?> <?php echo ('Receipt'); ?> </a>
                    <?php } ?>
