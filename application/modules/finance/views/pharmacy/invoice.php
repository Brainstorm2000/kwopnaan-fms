            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body col-md-5 panel-moree" id="invoice" style="font-size: 10px;">
                    <div class="row invoice-list">
                        ...
                        <?php } ?>
                        <div class="col-lg-4 col-sm-4">
                            <h4> <?php echo ('RECEIPT INFO'); ?> </h4>
                            <ul class="unstyled">
                                <li> <?php echo ('Receipt Number'); ?> 		: <strong>00<?php echo $payment->id; ?></strong></li>
                                <!--
                ...
                <div class="col-md-5 panel-moree" style="font-size: 10px;">
                    ...
                    <div class="text-center invoice-btn clearfix">
                        <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                            <a href="finance/pharmacy/editPayment?id=<?php echo $payment->id; ?>" class="btn btn-info btn-lg green pull-left"><i class="fa fa-edit"></i> <?php echo ('Edit Receipt'); ?> </a>
                        <?php } ?>
                    </div>
