        ...
        <section class="">
            <header class="panel-heading">
                ...
                <div class="col-md-4 no-print pull-right"> 
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Pharmacist'))) { ?>
                        ...
                        <?php foreach ($payments as $payment) { ?>
                            ...
                            <tr class="">
                                ...
                                <td> 
                                    ...
                                    <a class="btn btn-xs invoicebutton" style="color: #fff;" href="finance/pharmacy/invoice?id=<?php echo $payment->id; ?>"><i class="fa fa-dollar"></i>  <?php echo ('Pay'); ?></a>
